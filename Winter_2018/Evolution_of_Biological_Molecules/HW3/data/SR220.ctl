seqfile = ~/Dropbox/evol-biol-mol/homeworks/hw3/data/SR220-DBDs.phy
outfile = ~/Dropbox/evol-biol-mol/homeworks/hw3/results/temp.out
treefile = ~/Dropbox/evol-biol-mol/homeworks/hw3/data/SR220.tre
verbose = 2
noisy = 9
runmode = 0 * Use user-supplied tree? 0:yes 1:no
seqtype = 2  * 1:codons; 2:AAs; 3:codons-->AAs
aaRatefile = /Users/JoeThornton/Desktop/homeworks/hw5/paml4.7/dat/jones.dat * only used for aa seqs with model=empirical(_F) dayhoff.dat, jones.dat, wag.dat, mtmam.dat, or your own
