...
$P(X is odd) = P(X = 1) + P(X = 3) + P(X = 5) + ... + P(X = i) = \sum_{k=1}^{\infty} q(1-p)^{(K+2)-1} = (0.7)(1-0.7)^{0} + (0.7)(1-0.7)^{2} + ...$  
...
However, the : $P(X = 1) = P(X = 3) = P(X = 100)$  
...
Which has a range of about -5 to 5 approximately. Thus is if we integrate between the areas which will be rounded to an odd number we can take one minus that values to figure out the probability of getting an odd number.
