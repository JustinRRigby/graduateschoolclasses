...
Comment: You are using wrong delta G. Also check the units for R. -1
...
Comment: You are using wrong delta G from part (a), and you also need to check the units for R. -1
...
Comment: You don't need to explain T62A. But note that you are describing T62A (ddG = -1.1 kcal/mol) as being more detrimental to folding than R35A (ddG = -2.1 kcal/mol), which is not the case. For R35A, can you say something more specific than just the charge? Is the arginine forming hydrogen bonds with other residues? -0.5
...
Comment: You are answering a wrong question. -1
...
Comment: There are 19 other amino acid states, not 18 as is implied in your equations. You did not answer how this selection coefficient should change when the population size is larger. -0.5
...
Comment: This is a haploid population. -0.5
...
Comment: Check how the concentration of free drummondase is related to growth rate. You are using wrong selection coefficients for A22S and A22F. -0.5
...
Comment: What is this formula and what does it mean? For this question, you should describe how the rate will change (increase, decrease, no change) and provide a rational. -1
