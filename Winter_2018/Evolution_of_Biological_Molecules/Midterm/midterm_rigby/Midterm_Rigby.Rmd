...
One of the things which was cleared up for me in the class was the idea of neutral theory. The neutral theory is the idea that changes in the building blocks of our DNA are not always changed for a reason, but can happen by chance. In the case of proteins, we see that these neutral mutation are found a lot near the outside of proteins since those places are not used in the actual job of it. This is because these building blocks of DNA are not being forced to stay in the same state, so they have the chance to change into a different building block that may not be used in the job of the protein. Over time, these changes can build up and cause the protein to become less strong to the point where it may become so different that it may not be able to do its job.
