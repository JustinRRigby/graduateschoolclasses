...
$S_{ba} = 5*10^{12} - 0.5 = 5*10^{12}$ [Only one sig fig]  
...
Since the seleciton coefficent is so small we use the equation $P_{fix} = 2s$ because it will give us the expected frequency.  
